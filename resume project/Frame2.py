...
class Frame2:    
    ...
    def skip(self):
        messagebox.showwarning('Attention', "Can't skip personal information")
    ...
    def getdata(self):
        ...
        if a!='' and b!='' and c!='' and d!='':
            data={'Name - ':a,'Age - ':b,'Height - ':c,'Rel. Status - ':d}
            for i in range(0,len(self.var1)):
                if self.var1[i].get()!='' and self.var[i].get()!='':
                    data.update({self.var1[i].get()+' - ':self.var[i].get()})
                else:
                    messagebox.showwarning('Attention', 'All Fields are mandatory')
                    break
            print(data)
            Frame3.Frame3.data.append(data)
            self.fr2.destroy()
    ...
    def create2(self):
        ...
        self.fr2.place(x=0, y=0, width=1000, height=650)
        ...
        self.lbl12=Label(self.fr2, text='Age - ')
        ...
        self.lbl13=Label(self.fr2, text='Height - ')
        ...
        self.btn2 = Button(self.fr2, text='Add no. of new field', command=self.addnew)
        self.btn2.place(x=700, y=550, width=200, height=30)

        self.btn=Button(self.fr2,text='Next >', command=lambda :self.getdata())
        self.btn.place(x=600, y=600, width=300, height=50)

        self.btn1=Button(self.fr2,text='Skip ^', command=lambda :self.skip())
